...
export function SiteFooter() {
  return (
    <footer className="mt-24 bg-surface-deep text-surface-deep-foreground">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-3">
        <div>
          <h2 className="font-[family-name:var(--font-display)] text-xl">{profile.name}</h2>
          <p className="mt-3 max-w-xs text-sm opacity-70">{profile.tagline}</p>
        </div>

        <div>
          <p className="eyebrow !text-current opacity-60">Navigate</p>
